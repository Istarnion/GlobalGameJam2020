...
var Animation = /*#__PURE__*/function () {
  function Animation(name) {
    ...
    if (typeof def.frames === "number") {
      ...
      // Array of frames
      var _iterator = _createForOfIteratorHelper(def.frames),
          _step;
    ...
    value: function update(deltaTime) {
      if (!this.paused) {
        ...
        if (this.timeOnCurrentFrame >= this.timePerFrame) {
          ...
          if (this.direction !== 0) {
            var _iterator2 = _createForOfIteratorHelper(this.frameListeners),
                _step2;
          ...
          if (this.currentFrame >= this.numFrames || this.currentFrame < 0) {
            ...
            var _iterator3 = _createForOfIteratorHelper(this.cycleListeners),
                _step3;
...
var BlockFadeEffect = /*#__PURE__*/function (_GameObject) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2___default()(BlockFadeEffect, _GameObject);

  var _super = _createSuper(BlockFadeEffect);
...
/* harmony import */ var _musicManager_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./musicManager.js */ "./src/musicManager.js");
...
var CreditsRoom = /*#__PURE__*/function (_Room) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2___default()(CreditsRoom, _Room);

  var _super = _createSuper(CreditsRoom);
  ...
  function CreditsRoom() {
    ...
    _this.buttons = [{
      ...
      onclick: function onclick() {
        _musicManager_js__WEBPACK_IMPORTED_MODULE_9__["musicManager"].playSFX('button');
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(CreditsRoom, [{
    key: "init",
    value: function init() {
      _musicManager_js__WEBPACK_IMPORTED_MODULE_9__["musicManager"].setCreditsState();
    }
  }, {
    key: "resume",
...
var RoomStack = /*#__PURE__*/function () {
  function RoomStack() {
...
/* harmony import */ var _musicManager_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./musicManager.js */ "./src/musicManager.js");
...
var GameRoom = /*#__PURE__*/function (_Room) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(GameRoom, _Room);
  ...
  function GameRoom() {
    ...
    _this.player = new _player_js__WEBPACK_IMPORTED_MODULE_8__["Player"](_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this));
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(GameRoom, [{
    key: "init",
    value: function init() {
      _musicManager_js__WEBPACK_IMPORTED_MODULE_12__["musicManager"].setGameState();
    }
  }, {
    key: "resume",
    value: function resume() {
    ...
    for (var key in this.keyStates) {
      if (this.keyStates.hasOwnProperty(key)) {
        ...
        if (currState && !prevState) {
          ...
          if (this.specificKeyDownListeners.hasOwnProperty(key)) {
            var _iterator = _createForOfIteratorHelper(this.specificKeyDownListeners[key]),
                _step;
          ...
          var _iterator2 = _createForOfIteratorHelper(this.keyDownListeners),
              _step2;
          ...
          if (this.specificKeyUpListeners.hasOwnProperty(key)) {
            var _iterator3 = _createForOfIteratorHelper(this.specificKeyUpListeners[key]),
                _step3;
          ...
          var _iterator4 = _createForOfIteratorHelper(this.keyUpListeners),
              _step4;
...
/* harmony import */ var _musicManager_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./musicManager.js */ "./src/musicManager.js");
...
var MenuRoom = /*#__PURE__*/function (_Room) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2___default()(MenuRoom, _Room);

  var _super = _createSuper(MenuRoom);
  ...
  function MenuRoom() {
    ...
    _this.buttons = [{
      ...
      click_y: 0,
      onclick: function onclick() {
        _musicManager_js__WEBPACK_IMPORTED_MODULE_10__["musicManager"].playSFX('button');
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(MenuRoom, [{
    key: "init",
    value: function init() {
      _musicManager_js__WEBPACK_IMPORTED_MODULE_10__["musicManager"].setMenuState();
    }
  }, {
    key: "resume",
    value: function resume() {
...
var MusicManager = /*#__PURE__*/function () {
  function MusicManager() {
    ...
    this.sfx = {
      yoink: new howler__WEBPACK_IMPORTED_MODULE_2__["Howl"]({
        src: ['res/sounds/Yoink.wav'],
        volume: 0.1
      }),
      place: new howler__WEBPACK_IMPORTED_MODULE_2__["Howl"]({
        src: ['res/sounds/Place.wav'],
        volume: 0.5
      }),
      backpack: new howler__WEBPACK_IMPORTED_MODULE_2__["Howl"]({
        src: ['res/sounds/Backpack.wav'],
        volume: 0.5
      }),
      pickup: new howler__WEBPACK_IMPORTED_MODULE_2__["Howl"]({
        src: ['res/sounds/Pickup.wav'],
        volume: 0.5
      }),
      strawberry: new howler__WEBPACK_IMPORTED_MODULE_2__["Howl"]({
        src: ['res/sounds/Strawberry.wav'],
        volume: 0.5
      }),
      full: new howler__WEBPACK_IMPORTED_MODULE_2__["Howl"]({
        src: ['res/sounds/FullInventory.wav'],
        volume: 0.5
      }),
      open: new howler__WEBPACK_IMPORTED_MODULE_2__["Howl"]({
        src: ['res/sounds/OpenTablet.wav'],
        volume: 0.5
      }),
      close: new howler__WEBPACK_IMPORTED_MODULE_2__["Howl"]({
        src: ['res/sounds/CloseTablet.wav'],
        volume: 0.5
      }),
      button: new howler__WEBPACK_IMPORTED_MODULE_2__["Howl"]({
        src: ['res/sounds/Button.wav'],
        volume: 0.5
      })
    };
    this.footsteps = new howler__WEBPACK_IMPORTED_MODULE_2__["Howl"]({
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(MusicManager, [{
    ...
    key: "playSFX",
    value: function playSFX(sound) {
      this.sfx[sound].play();
    }
  }, {
    key: "playFootsteps",
    value: function playFootsteps(should_play) {
...
var PickupEffect = /*#__PURE__*/function (_GameObject) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2___default()(PickupEffect, _GameObject);

  var _super = _createSuper(PickupEffect);
...
/* harmony import */ var _musicManager_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./musicManager.js */ "./src/musicManager.js");
...
var Player = /*#__PURE__*/function (_GameObject) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2___default()(Player, _GameObject);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Player, [{
    ...
    value: function update(dt) {
      if (this.state == states.PLATFORMING) {
        ...
        _musicManager_js__WEBPACK_IMPORTED_MODULE_14__["musicManager"].playFootsteps(Math.abs(movement_x) > 0);
        ...
        for (var pickupable in PICKUPABLES) {
          ...
          if (centertile === tile) {
            if (pickupable === 'backpack') {
              // Pickup backpack
              _musicManager_js__WEBPACK_IMPORTED_MODULE_14__["musicManager"].playSFX('backpack');
              this.inventory.push(null);
            } else if (pickupable === 'strawberry') {
              // WIN
              _musicManager_js__WEBPACK_IMPORTED_MODULE_14__["musicManager"].playSFX('strawberry');
              ...
              _musicManager_js__WEBPACK_IMPORTED_MODULE_14__["musicManager"].playSFX('pickup');
        ...
        if (this.can_open_ipad && _input_js__WEBPACK_IMPORTED_MODULE_7__["input"].isKeyJustPressed('e')) {
          _musicManager_js__WEBPACK_IMPORTED_MODULE_14__["musicManager"].playSFX('open');
        ...
        if (_input_js__WEBPACK_IMPORTED_MODULE_7__["input"].isKeyJustPressed('mouse')) {
          if (this.active_inventory_slot === null) {
            ...
            if (can_pickup && first_open_inventory_slot >= this.inventory.length) {
              _musicManager_js__WEBPACK_IMPORTED_MODULE_14__["musicManager"].playSFX('full');
            }
            ...
            if (can_pickup && first_open_inventory_slot < this.inventory.length) {
              ...
              for (var _i2 = 0, _tile_indices_to_remo = tile_indices_to_remove; _i2 < _tile_indices_to_remo.length; _i2++) {
                ...
                _musicManager_js__WEBPACK_IMPORTED_MODULE_14__["musicManager"].playSFX('yoink');
            ...
            if (can_place) {
              _musicManager_js__WEBPACK_IMPORTED_MODULE_14__["musicManager"].playSFX('place');
              ...
              _musicManager_js__WEBPACK_IMPORTED_MODULE_14__["musicManager"].playSFX('close');
    ...
    value: function updateHUD() {
      ...
      this.map.tileset.drawTile(19, backpack_x, hud_y); // Scroll right edge
      ...
      if (this.can_open_ipad) {
        var number_keys = ['one', 'two', 'three', 'four', 'five'];

        for (var i = 0; i < number_keys.length; ++i) {
          if (_input_js__WEBPACK_IMPORTED_MODULE_7__["input"].isKeyJustPressed(number_keys[i]) && this.inventory.length > i) {
            if (this.inventory[i] !== null) {
              this.held_item = this.inventory[i];
              this.active_inventory_slot = i;
    ...
    value: function collidesAt(x, y) {
      var ct = this.tileAt(x, y);

      if (ct === STAIRS_LEFT || ct === STAIRS_RIGHT) {
        var offset = Math.floor(x % this.map.tile_width);
        var base_y = Math.floor(y / this.map.tile_height) * this.map.tile_height;

        if (ct === STAIRS_LEFT && y > base_y + offset || ct === STAIRS_RIGHT && y > base_y + (this.map.tile_height - offset)) {
          return true;
        }
      }
...
function createTileset(ts) {
  ...
  for (var tile in ts.tiles) {
    if (ts.tiles[tile].hasOwnProperty('animation')) {
      ...
      var _iterator = _createForOfIteratorHelper(ts.tiles[tile].animation),
          _step;
...
var TiledMap = /*#__PURE__*/function () {
  function TiledMap(map_name) {
    ...
    if (typeof map.properties !== 'undefined') {
      var _iterator2 = _createForOfIteratorHelper(map.properties),
          _step2;
    ...
    var _iterator3 = _createForOfIteratorHelper(map.layers),
        _step3;
      ...
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        if (l.type === "tilelayer") {
          ...
          if (typeof l.properties !== 'undefined') {
            var _iterator4 = _createForOfIteratorHelper(l.properties),
                _step4;
          ...
          var _iterator5 = _createForOfIteratorHelper(l.objects),
              _step5;
          ...
          var _iterator6 = _createForOfIteratorHelper(l.properties),
              _step6;
...
var TimerInstance = /*#__PURE__*/function () {
...
/* harmony import */ var _graphics_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./graphics.js */ "./src/graphics.js");
/* harmony import */ var _input_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./input.js */ "./src/input.js");
/* harmony import */ var _musicManager_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./musicManager.js */ "./src/musicManager.js");
...
var VictoryRoom = /*#__PURE__*/function (_Room) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2___default()(VictoryRoom, _Room);

  var _super = _createSuper(VictoryRoom);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(VictoryRoom, [{
    ...
    value: function update(dt) {
      ...
      for (var pickupable in pickupables) {
        ...
        var _iterator = _createForOfIteratorHelper(this.pickups),
            _step;
